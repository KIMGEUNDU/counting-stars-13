  ...
  return (
    <>
      <main className="w-[80%] mx-auto">
        <h2 className="text-[23px] font-bold">장바구니</h2>

        <div className="my-10">
          <div className="w-full flex justify-center border-b-[1px] mb-8">
            <h3 className="text-[20px] font-bold border-b-[2px] border-gray-900 inline py-3 px-4 ">
              배송상품 ({deliveryNum})
            </h3>
          </div>
          <div className="">
            ...
            <div className="h-20 text-[15px] font-medium flex justify-between items-center bg-gray-50 font-bold py-1 border-b-2 px-4 ">
