...
function DetailProductResult({
  ...
  return (
    <>
      <fieldset className="border-b-[1px] border-t-[1px] border-t-gray-500 border-b-gray-500 py-3 flex justify-between items-center">
        <div>
      ...
      <p className="py-6 border-b-[1px] border-b-gray-300">
        ...
        <span className="font-bold text-2xl pl-2">{price}원</span>
        &#40;{quantity}개&#41;
      </p>
    </>
  );
